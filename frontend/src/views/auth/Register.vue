      ...
      <div class="w-full max-w-md transform transition-all relative">
        ...
        <div class="backdrop-blur-sm bg-white/10 rounded-2xl p-8 shadow-2xl border border-white/20">
          <div class="text-center mb-8">
            <h2 class="text-4xl font-extrabold mb-3 drop-shadow-lg tracking-tight bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent">Daftar</h2>
            <p class="text-sm text-blue-100 font-medium">Buat akun baru untuk mengakses layanan kami</p>
          </div>
          ...
          <form @submit.prevent="handleRegister" class="space-y-5">
            <div class="group">
              <label for="name" class="block text-blue-50 mb-2 text-sm font-medium tracking-wide">Nama Lengkap</label>
              <div class="relative">
                <input
                  id="name"
                  v-model="form.name"
            ...
            <div class="flex items-center space-x-2">
              ...
              >
              <label for="agree" class="text-blue-50 text-sm">
